...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"addpoints_with_curve" : [ 10.638297872340425, 0.0, 0, 0.0, 143.61702127659575, 0.96, 0, 0.0, 436.170212765957444, 0.56, 0, 0.0, 861.702127659574444, 0.053333333333333, 0, 0.0 ],
					"classic_curve" : 1,
					"id" : "obj-38",
					"maxclass" : "function",
					"mode" : 1,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 1006.0, 741.0, 200.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 964.0, 1020.0, 40.0, 22.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1056.0, 877.0, 59.0, 22.0 ],
					"text" : "mc.target"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 893.0, 826.0, 43.0, 22.0 ],
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "setvalue", "int" ],
					"patching_rect" : [ 893.0, 917.0, 59.0, 22.0 ],
					"text" : "mc.target"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 893.0, 864.0, 63.0, 22.0 ],
					"text" : "random 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 907.0, 958.0, 108.0, 22.0 ],
					"text" : "mc.sig~ @chans 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "multichannelsignal", "", "" ],
					"patching_rect" : [ 1056.0, 945.0, 122.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1017.0, 697.0, 43.0, 22.0 ],
					"text" : "r bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1356.0, 515.0, 35.0, 22.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1337.0, 598.0, 54.0, 22.0 ],
					"text" : "mc.adc~"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "52 53 54 55 57 58 60 64 66 70 72 75 77 80 82 83"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "58 55 53 52 54 57 60 64 66 70 72 75 77 80 82 83"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "81 77 72 66 61 58 55 53 52 54 57 60 64 66 70 72"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1207.0, 582.0, 69.0, 40.0 ],
					"text" : "mc."
				}
