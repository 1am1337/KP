...
This data package contains the data that powers the chart ["Monthly average surface temperatures by year"](https://ourworldindata.org/grapher/monthly-average-surface-temperatures-by-year?country=~DEU&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website.
